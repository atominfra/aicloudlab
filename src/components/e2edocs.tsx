        ...
        <AccordionContent className="p-6 pt-0 text-base">
          <ol className="list-decimal pl-5 space-y-4">
            <div className="py-2 border-b">
              <h3 className="font-semibold mb-1">Log in to MyAccount</h3><ul className="list-disc pl-10 mt-1 space-y-1">
              <li className="">Visit  <a href="https://e2enetworks.com/" target="_blank" className="text-blue-700 underline">MyAccount</a> and log in using your credentials.</li>
              </ul>
            </div>
            <div className="py-2 border-b">
              <h3 className="font-semibold mb-1">Go to the API Section</h3>
              <ul className="list-disc pl-10 mt-1 space-y-1">
              <li className="">Navigate to the  <a href="https://myaccount.e2enetworks.com/services/apiiam" target="_blank" className="text-blue-700 underline">API page</a>.</li>
              </ul>
            </div>
