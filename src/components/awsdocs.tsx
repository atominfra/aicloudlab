        ...
        <AccordionContent className="p-4 pt-0 text-base">
          <ol className="list-decimal pl-5 space-y-4">
            <li className="py-2 border-b">
              ...
              <p>Log in to the <a href="https://aws.amazon.com/console/" target="_blank" className="text-blue-700 underline">AWS Management Console</a>.</p>
            </li>
            <li className="pb-2 border-b">
              <h3 className="font-semibold mb-1">Access IAM Dashboard</h3>
              <ul className="list-disc pl-5 mt-1 space-y-1">
                <li>Go to the  <a href="https://us-east-1.console.aws.amazon.com/iam/home?region=ap-south-1#/users" target="_blank" className="text-blue-700 underline">IAM Dashboard</a>.</li>
